...
const {secure_url} = await cloudinary.uploader.upload(base64Image)
  ...
  VALUES (${userId}, ${prompt}, ${secure_url}, 'image', ${publish ?? false})`;
     ...
     //console.log("CLIPDROP_API_KEY:", process.env.CLIPDROP_API_KEY);
   ...
   transformation: [
        {
          ...
          background_removal: 'cloudinary_ai',  //this line is changed from the youtube video as it was not working
        },
      ],
})
...
if(resume.size > 5 * 1024 * 1024){
    return res.json({success: false, message: "Resume file size exceeds allowed size of 5MB."})
}
