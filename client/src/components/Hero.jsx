  ...
  return (
    <div className='px-4 sm:px-20 xl:px-32 relative inline-flex flex-col w-full justify-center
     bg-[url(/gradientBackground.png)] bg-cover bg-no-repeat min-h-screen'>
      ...
      <div className='text-center mb-6'>
         ...
         max-sm:text-xs text-gray-600'>Transform your content creation with our suite of premium AI tools. Write articles , generate
         ...
         <div className='flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs'>
            ...
            transition cursor-pointer'>
             ...
             <button className='bg-white px-10 py-3 rounded-lg border border-gray-300 hover:scale-102 active:scale-95 
             transition cursor-pointer'>
                Watch demo</button>
         </div>
    ...
    <div className="flex justify-center mt-8">
        <div className="flex items-center gap-4 text-gray-600">
           <img src={assets.user_group} alt="user group" className="h-5" />
