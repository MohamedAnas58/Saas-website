...
const GenerateImages = () => {
     const imageStyle =[
               'Realistic', 'Ghibli style', 'Anime style', 'Cartoon style', 'Fanatsy style', 
  ...
  return (
   <div className='h-full overflow-y-scroll p-6 flex items-start gap-4 text-slate-700 flex-col lg:flex-row'>
      ...
      <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
        ...
        <button disabled={loading} className='w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#00AD25] to-[#04FF50]
text-white px-4 py-2 mt-6 text-sm rounded-lg cursor-pointer'>
  {
    ...
    animate-spin"></span> : <Image className='w-5' />
  }
      ...
      <div className='w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96 '>
           ...
           </div>
           {
            ...
            <div className='text-sm flex flex-col items-center gap-5 text-gray-400'>
                ...
                <p>Enter a topic and click "Generte Image" to get Started</p>
            </div>
