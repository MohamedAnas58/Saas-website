...
const BlogTitles = () => {
     ...
     const blogCategories =[
           'General', 'Technology', 'Buissness', 'Health', 'Lifestyle', 'Education', 'Travel', 'Food'
        ]
        ...
        const onSubmitHandler = async (e)=>{
            ...
            try{
                setLoading(true)
                const prompt =`Generate 5 blog titles about ${input} in the category ${selectedCategory} `
  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex items-start gap-4 text-slate-700 flex-col lg:flex-row'>
      ...
      <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
        ...
        <br/>
        <button disabled={loading} className='w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#C341F6] to-[#8E37EB]
      ...
      <div className='w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96 '>
           ...
           </div>
           {
            ...
            <div className='text-sm flex flex-col items-center gap-5 text-gray-400'>
                ...
                <p>Enter a topic and click "Generted title" to get Started</p>
            </div>
